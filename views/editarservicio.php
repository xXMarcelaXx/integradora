...
$ID = $_GET['id'];
$query = new select();
$cadena = "SELECT * FROM servicios WHERE id_servicio = $ID";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <form action="../views/scripts/actualizarservicio.php" method="POST">
                        <div class="row">
                            <!--Nombre servicio-->
                            <!--ssss-->
                            <div class="col-md-12" hidden>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nombre Servicio" name="id_servicio" value="<?php echo $registro->id_servicio ?>">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-circle"></i></span>
                                    <input type="text" class="form-control" required placeholder="Servicio" name="nombre_servicio" value="<?php echo $registro->nombre_servicio ?>">
                                </div>
                            </div>
                            <!--costo-->
                            <div class="col-md-5">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" placeholder="$Costo" name="costo" value="<?php echo $registro->costo ?>">
                                </div>
                            </div>
                            <!--descripcion-->
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <textarea name="descripcion" class="form-control" aria-label="With textarea"><?php echo $registro->descripcion ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                .
