...
?>
  ...
  <body>
    ...
    <main id="main">
      ...
      <div class="container">
        <div class="row">
          <h1>citas que no se finalizaron</h1>
          <div class="row">
            ...
            if ($_POST) {
              ...
              $cadena = "SELECT CI.cliente,CI.fecha,CI.servicio,CI.hora,CI.iva,CI.subtotal,CI.total,CI.cita FROM
                ...
                citas.id_citas 'cita',servicio_cita.id_ovcita 'ids' FROM cuenta INNER JOIN citas on citas.Usuario_C = cuenta.nombre_usuario
                ...
                WHERE citas.Status = 'Pendiente' AND citas.fecha BETWEEN '$FI' and  '$FF' GROUP BY servicio_cita.dt_cita) AS CI";
              $tabla = $query->seleccionar($cadena);
            ?>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../views/scripts/citacancelada.php" method="post">
                                ...
                                <input type="text" value="<?php echo "$registro->cita" ?>" hidden name="id">
                            </div>
