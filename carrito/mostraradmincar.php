    ...
    <div class="container">
        ...
        <?php if (!empty($_SESSION['CARRITO'])) { ?>
            <table class="table ">
                <tbody>
                    ...
                    <tr>
                        <td colspan="5">
                            <form action="pagaradmin.php" method="POST">
                                ...
                                <a href="../views/tiendaadmin.php" class="btn btn-primary" type="button">Tienda</a>
        ...
        <?php } else { ?>
            ...
            <div class="alter alter-success">
                ...
                <br>
                <a href="../views/vistaadmin.php" class="btn btn-primary">regresar</a>
            </div>
